...
@Entity
@Table(name = "nota_fical_compra")
@SequenceGenerator(name = "seq_nota_fical_compra", sequenceName = "seq_nota_fical_compra", allocationSize = 1, initialValue = 1)
public class NotaFiscalCompra implements Serializable{
	...
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seq_nota_fical_compra")
	private Long id;
